            ...
            posts.map(post => (
              <div key={post.id} className="bg-white p-6 rounded-lg shadow-lg transition-transform transform hover:scale-105">
                ...
                <div className="flex justify-between items-center">
                  ...
                  <button onClick={() => handleDelete(post.id)} className="bg-red-500 text-white font-semibold py-2 px-4 rounded-lg shadow-lg transition-transform transform hover:scale-105">
                    Delete
                  </button>
                  </Link>
                </div>
